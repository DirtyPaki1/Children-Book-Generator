      ...
      >
        {pages.map((page, index) => (
          ...
          >
              ...
              {imageLoadStates[index] === 'loading' && (
                <div className="absolute inset-0 flex items-center justify-center bg-gray-100">
                  <div className="animate-pulse flex flex-col items-center">
                    ...
                    <span className="text-gray-600 text-sm">Loading illustration...</span>
                  </div>
                </div>
              )}
              ...
              {imageLoadStates[index] === 'error' ? (
                <div className="absolute inset-0 flex items-center justify-center bg-gray-200">
                  <div className="text-center p-4">
                    ...
                    <p className="text-xs text-gray-500 mt-1">Page {index + 1}</p>
                  </div>
                </div>
              ) : (
                <img
            ...
            <div className={`page-content flex-1 p-4 bg-gray-50 rounded-lg overflow-y-auto ${
